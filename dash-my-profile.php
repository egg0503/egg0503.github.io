                                                ...
                                                <div class="mega-menu-list">
                                                    <ul>
                                                        <li class="js-active">
                                                            ...
                                                            <a href="lshop-side-version-2.htm"><i class="fas fa-tv u-s-m-r-6"></i>
                            ...
                            <div class="breadcrumb__wrap">
                                <ul class="breadcrumb__list">
                                    ...
                                    <li class="is-marked">
                                        ...
                                        <a href="dash-my-profile.php">我的帳戶</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-9 col-md-12">
                                    <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white u-s-m-b-30">
                                        <div class="dash__pad-2">
                                            <h1 class="dash__h1 u-s-m-b-14">我的簡歷</h1>

                                            <span class="dash__text u-s-m-b-30">查看所有信息，您可以自定義個人資料。</span>
                                            <div class="row">
                                                <div class="col-lg-4 u-s-m-b-30">
                                                    <h2 class="dash__h2 u-s-m-b-8">姓名</h2>
                                                ...
                                                <div class="col-lg-4 u-s-m-b-30">
                                                    <h2 class="dash__h2 u-s-m-b-8">手機號碼</h2>
                                                ...
                                                <div class="col-lg-4 u-s-m-b-30">
                                                    <h2 class="dash__h2 u-s-m-b-8">生日</h2>

                                                    <span class="dash__text">
                                                    <?php
                                                    print_r($rows['Birthday']);
                                                    ?>
                                                    </span>
                                                </div>
                                                <div class="col-lg-4 u-s-m-b-30">
                                                    <h2 class="dash__h2 u-s-m-b-8">性別</h2>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="u-s-m-b-16">
                                                        ...
                                                        <a class="dash__custom-link btn--e-transparent-brand-b-2" href="dash-edit-profile.php">編輯個人資料</a></div>
                                                    <div>

                                                        <a class="dash__custom-link btn--e-brand-b-2" href="dash-edit-password.php">更改密碼</a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body">
                        <form class="d-modal__form">
                            <div class="u-s-m-b-15">
                                ...
                                <a class="d_modal__link" href="dash-my-profile.php">Ludus Privacy Policy</a>
                            </div>
