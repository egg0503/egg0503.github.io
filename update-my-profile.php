...
$ph=$_POST['Phone'];
session_start();
if($fn==null||$ln==null||$data==null||$ph==null||$acc==null)
{    
        $dd="請輸入完整表單!";
        header('refresh:1;url=http://localhost/Workfile/dash-edit-profile.php');
}
else
{
    ...
    {
        $u_acc=$_COOKIE['Email']; 
        $UpdateSql="UPDATE users SET First_Name = '$fn',Last_Name = '$ln',Birthday = '$data',Email = '$acc',Gender='$gender',Phone = '$ph'WHERE Email='$u_acc'";
        $result=$connect->query($UpdateSql);
        $_SESSION['acc'] = $_SESSION['Email'];
        setcookie('acc', $acc, time()+1*24*60*60);
        header('Location:http://localhost/Workfile/dash-edit-profile.php');
    }
    else
    {
        $u_acc=$_COOKIE['acc']; 
                                        ...
                                        <div class="mini-cart">
                                            ...
                                            <div class="mini-product-stat">
                                                ...
                                                <div class="mini-action">
                                                    ...
                                                    <a class="mini-link btn--e-transparent-secondary-b-2" href="cart.php">查看購物車</a></div>
                                            </div>
                            ...
                            <div class="breadcrumb__wrap">
                                <ul class="breadcrumb__list">
                                    ...
                                    <li class="is-marked">
                                        ...
                                        <a href="dash-edit-profile.php">我的帳戶</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
