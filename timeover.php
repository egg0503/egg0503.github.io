<?php 
 header('refresh:5;url=http://localhost/Workfile/index.php');
?>
<!DOCTYPE html>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="section__text-wrap">
                                    <form>
                                    <h1 class="section__heading u-c-secondary">貼心小提醒!!! 已登入30分鐘</h1>
                                    <h1 class="section__heading u-c-secondary">即將登出，5秒內沒點擊繼續直接登出</h1>
                                    <input type ="button" onclick="history.back()" value="繼續"></input>
                                </div>
                            </div>
                        </div>
                    </div>
