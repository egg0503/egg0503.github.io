                                                ...
                                                <div class="mega-menu-list">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="shop-side-version-2.html"><i class="fas fa-utensils u-s-m-r-6"></i>
                            ...
                            <div class="breadcrumb__wrap">
                                <ul class="breadcrumb__list">
                                    ...
                                    <li class="is-marked">
                                        ...
                                        <a href="dash-my-order.php">我的帳戶</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-9 col-md-12">
                                    <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white u-s-m-b-30">
                                        <div class="dash__pad-2">
                                            <h1 class="dash__h1 u-s-m-b-14">我的訂單</h1>

                                            <span class="dash__text u-s-m-b-30">在這裡，您可以查看所有已交付的產品。</span>
                                            <form class="m-order u-s-m-b-30">
                                                <div class="m-order__select-wrapper">

                                                    <label class="u-s-m-r-8" for="my-order-sort">展示:</label><select class="select-box select-box--primary-style" id="my-order-sort">
                                                        <option selected>最近5個訂單</option>
                                                        <option>最近15天</option>
                                                        <option>最近30天</option>
                                                        <option>最近6個月</option>
                                                        <option>2020年下的訂單</option>
                                                        <option>所有訂單</option>
                                                    </select></div>
                                            </form>
                                            <div class="m-order__list">
                                                <div class="m-order__get">
                                                    <div class="manage-o__header u-s-m-b-30">
                                                        <div class="dash-l-r">
                                                            <div>
                                                                <div class="manage-o__text-2 u-c-secondary">訂單 #305423126</div>
                                                                <div class="manage-o__text u-c-silver">於2020年1月26日09:08:37抵達</div>
                                                            </div>
                                                            <div>
                                                    ...
                                                    <div class="manage-o__description">
                                                        ...
                                                        <div class="description__info-wrap">
                                                            <div>
                                                                ...
                                                                <span class="manage-o__badge badge--processing">處理中</span></div>
                                                            <div>

                                                                <span class="manage-o__text-2 u-c-silver">數量：

                                                                    <span class="manage-o__text-2 u-c-secondary">1</span></span></div>
                                                            <div>

                                                                <span class="manage-o__text-2 u-c-silver">總計:
                                                    ...
                                                    <div class="manage-o__description">
                                                        ...
                                                        <div class="description__info-wrap">
                                                            <div>
                                                                ...
                                                                <span class="manage-o__badge badge--shipped">處理中</span></div>
                                                            <div>
                                                    ...
                                                    <div class="manage-o__description">
                                                        ...
                                                        <div class="description__info-wrap">
                                                            <div>
                                                                ...
                                                                <span class="manage-o__badge badge--delivered">處理中</span></div>
                                                            <div>
