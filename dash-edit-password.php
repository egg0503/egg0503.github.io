...
{
    $u_acc=$_COOKIE['Email']; 
    $SelectSql="SELECT  `First_name`, `Last_name` FROM users  Where Email='$u_acc'";
                                ...
                                <div class="col-lg-9 col-md-12">
                                    <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white">
                                        <div class="dash__pad-2">
                                            <h1 class="dash__h1 u-s-m-b-14">更改密碼</h1>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <form class="dash-edit-p" method="POST" action="./update-password.php">
                                                    <div class="u-s-m-b-30">
                                                    <label class="gl-label" for="login-old-password">原密碼*</label>

                                                    <input class="input-text input-text--primary-style" type="password" id="login-password" name="oldpassword" placeholder="輸入原密碼"></div>
                                                    <div class="u-s-m-b-30">

                                                    <label class="gl-label" for="login-new-password">新密碼*</label>
                                                    <input class="input-text input-text--primary-style" type="password" id="login-password" name="newpassword" placeholder="輸入新密碼"></div>
                                                    <div class="u-s-m-b-30">

                                                    <label class="gl-label" for="login-new-password">確認新密碼*</label>
                                                    <input class="input-text input-text--primary-style" type="password" id="login-password" name="nspassword" placeholder="再次輸入新密碼"></div>
                                                    <div class="u-s-m-b-30">

                                                        <button class="btn btn--e-transparent-brand-b-2" type="submit">確認更改</button></div>
                                                    <div class="u-s-m-b-30">
                                                    </form>
                                                </div>
                                            </div>
