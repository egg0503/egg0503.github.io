...
{
    $u_acc=$_COOKIE['Email']; 
    $SelectSql="SELECT  `First_name`, `Last_name`, `Email` FROM users  Where Email='$u_acc'";
                                                ...
                                                <div class="mega-menu-list">
                                                    <ul>
                                                        <li class="js-active">
                                                            ...
                                                            <a href="sshop-side-version-2.php"><i class="fas fa-tv u-s-m-r-6"></i>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="sshop-side-version-2.php?id=1"><i class="fas fa-female u-s-m-r-6"></i>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="sshop-side-version-2.php?id=2"><i class="fas fa-male u-s-m-r-6"></i>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="sshop-side-version-2.php?id=3"><i class="fas fa-utensils u-s-m-r-6"></i>
                            ...
                            <div class="ah-lg-mode">
                                ...
                                <ul class="ah-list ah-list--design2 ah-list--link-color-secondary">
                                    ...
                                    <li>
                                        ...
                                        <a href="sshop-side-version-2.php">市場均價</a></li>
                                    <li>

                                        <a href="sshop-side-version-2.php">折扣卡</a></li>
                                </ul>
                                <!--====== End - List ======-->
                            </div>
                            <!--====== End - Menu ======-->
                                                    ...
                                                    <div class="mini-product">
                                                        ...
                                                        <div class="mini-product__info-wrapper">
                                                            ...
                                                            <span class="mini-product__category">
                                                                ...
                                                                <a href="sshop-side-version-2.php">Electronics</a></span>
                            ...
                            <div class="breadcrumb__wrap">
                                <ul class="breadcrumb__list">
                                    ...
                                    <li class="is-marked">
                                        ...
                                        <a href="dashboard.html">我的帳戶</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-3 col-md-12">
                                    ...
                                    <div class="dash__box dash__box--bg-white dash__box--shadow u-s-m-b-30">
                                        <div class="dash__pad-1">
                                            ...
                                            <span class="dash__text u-s-m-b-16">歡迎,<?php print_r($rows['First_name']); print_r($rows['Last_name']);?></span>
                                ...
                                <div class="col-lg-9 col-md-12">
                                    <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white u-s-m-b-30">
                                        <div class="dash__pad-2">
                                            <h1 class="dash__h1 u-s-m-b-14">管理我的帳戶</h1>

                                            <span class="dash__text u-s-m-b-30">在“我的帳戶”儀表板上，您可以查看最近帳戶活動的快照並更新您的帳戶信息。 選擇下面的鏈接以查看或編輯信息。</span>
                                            <div class="row">
                                                <div class="col-lg-4 u-s-m-b-30">
                                                    <div class="dash__box dash__box--bg-grey dash__box--shadow-2 u-h-100">
                                                        <div class="dash__pad-3">
                                                            <h2 class="dash__h2 u-s-m-b-8">個人簡介</h2>
                                                            <div class="dash__link dash__link--secondary u-s-m-b-8">
                                                            <span class="dash__text">
                                                            <?php
                                                            print_r($rows['First_name']);
                                                            print_r($rows['Last_name']);
                                                            ?>
                                                            </span>
                                                            </div>
                                                            <h2 class="dash__h2 u-s-m-b-8">電子郵件</h2>
                                                            <div class="dash__link dash__link--secondary u-s-m-b-8">
                                                            <span class="dash__text">
                                                            <?php
                                                            print_r($rows['Email']);
                                                            ...
                                                            <a href="dash-edit-profile.php">編輯</a></div>
                                                ...
                                                <div class="col-lg-4 u-s-m-b-30">
                                                    <div class="dash__box dash__box--bg-grey dash__box--shadow-2 u-h-100">
                                                        <div class="dash__pad-3">
                                                            <h2 class="dash__h2 u-s-m-b-8">地址簿</h2>

                                                            <span class="dash__text-2 u-s-m-b-8">默認送貨地址</span>
                                                            <div class="dash__link dash__link--secondary u-s-m-b-8">

                                                                <a href="dash-address-book.html">編輯</a></div>

                                                            <span class="dash__text">台北市內湖區XX號</span>

                                                            <span class="dash__text">0987987378</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 u-s-m-b-30">
                                                    <div class="dash__box dash__box--bg-grey dash__box--shadow-2 u-h-100">
                                                        <div class="dash__pad-3">
                                                            <h2 class="dash__h2 u-s-m-b-8">帳單地址</h2>

                                                            <span class="dash__text-2 u-s-m-b-8">默認賬單地址</span>
                                    ...
                                    <div class="dash__box dash__box--shadow dash__box--bg-white dash__box--radius">
                                        <h2 class="dash__h2 u-s-p-xy-20">最近的訂單</h2>
                                                        ...
                                                        <td>
                                                            <div class="dash__table-total">
                                                                ...
                                                                <div class="dash__link dash__link--brand">
                                                                    ...
                                                                    <a href="dash-manage-order.html">管理</a></div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <div class="outer-footer__list-wrap">
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <a href="sshop-side-version-2.php">我的商城</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="outer-footer__list-wrap">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <a href="sshop-side-version-2.php">商城</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
