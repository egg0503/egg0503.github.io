...
<a href="admin.php">主頁<i class="fas i-state-right u-s-m-l-6"></i></a>
...
<a>管理帳戶<i class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
...
<a>訂單<i class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
                            ...
                            <div class="ah-lg-mode">
                                ...
                                <ul class="ah-list ah-list--design1 ah-list--link-color-secondary">
                                    <li>
                                        ...
                                        <a href="admin.php"><i class="fas fa-home"></i></a></li>
                                    <li>
                            ...
                            <div class="shop-p">
                                <div class="shop-p__toolbar u-s-m-b-30">
                                    <div class="shop-p__meta-wrap u-s-m-b-60">
                                        ...
                                        <span class="shop-p__meta-text-1">管理者介面</span>
                                        <div class="shop-p__meta-text-2">

                                            <span></span>

                                            <a class="gl-tag btn--e-brand-shadow" href="upload.html">新增</a>

                                            <a class="gl-tag btn--e-brand-shadow" href="Modify and delete.html">修改</a>

                                            <a class="gl-tag btn--e-brand-shadow" href="Modify and delete.html">刪除</a></div>
                                    </div>
                                    <div class="shop-p__tool-style">
                                        <div class="tool-style__group u-s-m-b-8">
										
											<span class="js-shop-list-target is-active">清單</span>
                                            <span class="js-shop-grid-target ">圖格</span></div>
                                            ...
                                            <div  class="product-m">
                                                ...
                                                <div class="product-m__content">
                                                    <div class="product-m__category">
                                                        ...
                                                        <a href="shop-side-version-2.html">男裝</a></div>
                                            ...
                                            <div class="product-m">
                                                ...
                                                <div class="product-m__content">
                                                    <div class="product-m__category">
                                                        ...
                                                        <a href="shop-side-version-2.html">女裝</a></div>
                                                    <div class="product-m__name">
