                                                ...
                                                <div class="product-m__content">
                                                    ...
                                                    <a href="shop-side-version-2.html">
                                                        <?php
                                                            if($Cid==null)
                                                            {
                                                                $SelectSql = "SELECT Name FROM category Where id=1";
                                                    ...
                                                    <div class="product-m__name">
                                                        ...
                                                        <?php
                                                            if($Cid==null)
                                                            {
                                                                $Select2Sql="SELECT Name FROM category_product JOIN products ON category_product.product_id=products.id WHERE category_product.category_id=1";
                                            ...
                                            <div class="product-m">
                                                ...
                                                <div class="product-m__content">
                                                    <div class="product-m__category">
                                                        ...
                                                        <a href="shop-side-version-2-in.php?id=1">女裝</a></div>
                                                    <div class="product-m__name">
                                ...
                                <div class="u-s-p-y-60">
                                    ...
                                    <ul class="shop-p__pagination">
                                        <li class="is-active">
                                            ...
                                            <a href="shop-side-version-2-in.php">1</a></li>
                                        <li>

                                            <a href="shop-side-version-2-in.php">2</a></li>
                                        <li>

                                            <a href="shop-side-version-2-in.php">3</a></li>
                                        <li>

                                            <a href="shop-side-version-2-in.php">4</a></li>
                                        <li>

                                            <a class="fas fa-angle-right" href="shop-side-version-2-in.php"></a></li>
                                    </ul>
                                    <!--====== End - Pagination ======-->
                                </div>
                            </div>
                                ...
                                <div class="pd-breadcrumb u-s-m-b-30">
                                    <ul class="pd-breadcrumb__list">
                                        ...
                                        <li class="has-separator">
                                            ...
                                            <a href="shop-side-version-2-in.php">Electronics</a></li>
                                        <li class="has-separator">

                                            <a href="shop-side-version-2-in.php">DSLR Cameras</a></li>
                                        <li class="is-marked">

                                            <a href="shop-side-version-2-in.php">Nikon Cameras</a></li>
                                    </ul>
                                </div>
