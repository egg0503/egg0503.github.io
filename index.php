                                     ...
                                     echo'<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30 filter__item headphone">';
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30 filter__item headphone">
                                            <div class="product-o product-o--hover-on product-o--radius">
                                                ...
                                                <span class="product-o__price"><?php
													$selectSql = "SELECT Price FROM products_details WHERE p_id=6";
													$memberData = $connect->query($selectSql);
													if ($memberData->num_rows > 0) 
														{
														while ($rows = $memberData->fetch_assoc())
															{
																print_r("$".$rows['Price']);
												...
												?>
                                                    ...
                                                    <span class="product-o__discount">$160</span></span>
                                            </div>
                                        </div>
                                ...
                                <div class="pd-breadcrumb u-s-m-b-30">
                                    <ul class="pd-breadcrumb__list">
                                        <li class="has-separator">
                                            ...
                                            <a href="index.hml">首頁</a></li>
                                        <li class="has-separator">

                                            <a href="shop-side-version-2.html">飾品配件</a></li>
                                        <li class="has-separator">

                                            <a href="shop-side-version-2.html">皮包</a></li>
                                        <li class="is-marked">

                                            <a href="shop-side-version-2.html">皮夾</a></li>
                                    </ul>
                                </div>
                            ...
                            <div class="col-lg-6 new-l__col-2">
                                <div class="new-l__section u-s-m-t-30">
                                    <div class="u-s-m-b-8 new-l--center">
                                        <h3 class="new-l__h3">新會員</h3>
                                    </div>
                                    <div class="u-s-m-b-30 new-l--center">
                                        <p class="new-l__p1">先辦會員接著進入系統開始使用平台</p>
                                    </div>
                                    <form class="new-l__form">
                                        ...
                                        <div class="u-s-m-b-15">
                                            ...
                                            <button class="btn btn--e-brand-b-2" type="submit">登入!</button></div>
                                    </form>
                                    <div class="u-s-m-b-15 new-l--center">
                                        <p class="new-l__p2">簽署即表示您同意接受古著平台優惠，促銷和其他商業信息。 您可以隨時退訂。</p>
                                    </div>
                                    <div class="u-s-m-b-15 new-l--center">

                                        <a class="new-l__link" data-dismiss="modal">不需要</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
