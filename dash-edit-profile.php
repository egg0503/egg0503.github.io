...
{
    $u_acc=$_COOKIE['Email']; 
    $SelectSql="SELECT  `First_name`, `Last_name`, `Gender`, `Birthday`,  `Phone`, `Email` FROM users  Where Email='$u_acc'";
                            ...
                            <div class="breadcrumb__wrap">
                                <ul class="breadcrumb__list">
                                    ...
                                    <li class="is-marked">
                                        ...
                                        <a href="dash-edit-profile.html">我的帳戶</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-3 col-md-12">
                                    ...
                                    <div class="dash__box dash__box--bg-white dash__box--shadow u-s-m-b-30">
                                        <div class="dash__pad-1">
                                            ...
                                            <span class="dash__text u-s-m-b-16">歡迎, <?php print_r($rows['First_name']);print_r($rows['Last_name']);?>
                                            </span>
                                            <ul class="dash__f-list">
                                                <li>

                                                    <a class="dash-active" href="dashboard.php">管理我的帳戶</a></li>
                                                <li>

                                                    <a href="dash-my-profile.php">我的簡歷</a></li>
                                                <li>

                                                    <a href="dash-address-book.html">地址簿</a></li>
                                                <li>
                                                ...
                                                <li>
                                                    ...
                                                    <a href="dash-payment-option.html">我的付款方式</a></li>
                                                <li>

                                                    <a href="dash-cancellation.html">我的退貨和取消</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <ul class="dash__w-list">
                                                <li>
                                                    <div class="dash__w-wrap">
                                                        ...
                                                        <span class="dash__w-name">下訂單</span></div>
                                                </li>
                                                <li>
                                                    <div class="dash__w-wrap">
                                                        ...
                                                        <span class="dash__w-name">取消訂單</span></div>
                                                </li>
                                                <li>
                                                    <div class="dash__w-wrap">
                                                        ...
                                                        <span class="dash__w-name">願望清單</span></div>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-9 col-md-12">
                                    <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white">
                                        <div class="dash__pad-2">
                                            <h1 class="dash__h1 u-s-m-b-14">編輯個人資料</h1>

                                            <span class="dash__text u-s-m-b-30">您似乎尚未更新個人資料</span>
                                            <div class="dash__link dash__link--secondary u-s-m-b-30">

                                                <a data-modal="modal" data-modal-id="#dash-newsletter">訂閱新聞通訊</a></div>
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <form class="dash-edit-p" method="POST" action="./update-my-profile.php">
                                                        <div class="gl-inline">
                                                            <div class="u-s-m-b-30">

                                                                <label class="gl-label" for="reg-fname">姓氏</label>

                                                                <input class="input-text input-text--primary-style" type="text" id="reg-fname" name="First_Name" placeholder="<?php print_r($rows['First_name']);?>"></div>
                                                            <div class="u-s-m-b-30">

                                                                <label class="gl-label" for="reg-lname">名字</label>

                                                                <input class="input-text input-text--primary-style" type="text" id="reg-lname" name="Last_Name" placeholder="<?php print_r($rows['Last_name']);?>"></div>
                                                        </div>
                                                        <div class="gl-inline">
                                                            <div class="u-s-m-b-30">
                                                                ...
                                                                <h2 class="dash__h2 u-s-m-b-0">生日</h2>
                                                                <?php print_r($rows['Birthday']);?>
                                                                <input type="date"name="data" class="select-box select-box--primary-style">
                                                                <!--====== End - Date of Birth Select-Box ======-->
                                                            </div>
                                                            <div class="u-s-m-b-30">

                                                                <label class="gl-label" for="gender">性別
                                                                    <?php
                                                                    print_r($rows['Gender']);
                                                                    ?>
                                                                </label><select class="select-box select-box--primary-style u-w-100" id="gender"name="Gender">
                                                                    <option >男生</option>
                                                                    <option >女生</option>
                                                                </select></div>
                                                        </div>
                                                        <div class="gl-inline">
                                                            <div class="u-s-m-b-30">
                                                                <h2 class="dash__h2 u-s-m-b-0">電子信箱</h2>                                                               
                                                                <input class="input-text input-text--primary-style" type="email" id="reg-email" name="Email" placeholder=" <?php print_r($rows['Email']);?>">
                                                                <div class="dash__link dash__link--secondary">
                                                                </div>
                                                            </div>
                                                            <div class="u-s-m-b-30">
                                                                <h2 class="dash__h2 u-s-m-b-0">電話號碼</h2>                                                                
                                                                <input class="input-text input-text--primary-style" type="tel" id="reg-phone" name="Phone" placeholder="<?php print_r($rows['Phone']);?>   ">
                                                                <div class="dash__link dash__link--secondary">
                                                                </div>
                                                            </div>
                                                        </div>

                                                        <button class="btn btn--e-brand-b-2" type="submit">儲存</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
